...
> sealos一键安装：
```shell
https://github.com/miaocunfa/iKubernetes/blob/master/Sealos%E5%AE%89%E8%A3%85Kubernetes%20v1.16.0%20HA%E9%9B%86%E7%BE%A4.md
```
> KubeSphere一键安装：
```shell
https://www.cnblogs.com/kubesphere/p/11939357.html
```
> kubeadm一键安装：
```shell
https://www.cnblogs.com/qianjingchen/diary/2019/03/25/10418567.html
```
# 初始化脚本 init.sh
``` shell
#!/bin/bash
